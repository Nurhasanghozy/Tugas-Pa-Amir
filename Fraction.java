...
public class Fraction {
    ...
    public Fraction subtrac(Fraction fractionTwo){
    ...
    public Fraction divide(Fraction fractionTwo){
        ...
        int newDenominator = denominator * fractionTwo.getNumerator();
        Fraction result = new Fraction(newNumerator, newDenominator);
        return result;
    }
    
    public Fraction add(Fraction fractionTwo){
        int numr = (numerator * fractionTwo.getDenominator())+ (fractionTwo.getNumerator()*denominator);
